...
Organizes by: Dr. Jen/Housing, Edith/Property, City Heat Complaints, Nick/Matt/Concepts26, Good Will Easter Seals
"""
...
class EmailTranscriber:
    def __init__(self, mbox_path, output_dir):
        ...
        self.keywords = {
            ...
            'nick_concepts26': [
                'nick', 'concepts26', 'concepts 26', 'property management', 'manager'
            ],
            'good_will_easter_seals': [
                'good will', 'easter seals', 'job assistance', 'rehabilitation', 'employment services'
            ]
        }
    ...
    def export_all_conversations(self):
        ...
        exports = [
            ...
            ('nick_concepts26', 'Nick_Concepts26_Conversations'),
            ('good_will_easter_seals', 'Good_Will_Easter_Seals_Conversations')
        ]
